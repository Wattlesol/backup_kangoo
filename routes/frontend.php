...
Route::get('/service-package-list', [FrontendController::class, 'servicePackage_List'])->name('servicepackage.list');
...
Route::get('/service-package-detail/{id}', [FrontendController::class, 'servicepackageDetail'])->name('service-package.detail');
Route::post('/check-price', [FrontendController::class, 'checkPrice'])->name('checkPrice');
