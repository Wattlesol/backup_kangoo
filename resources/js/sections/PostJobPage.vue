  ...
  <div class="row align-items-center">
          <div class="col-md-4">
            <div class="text-md-start text-center">
              <a :href="`${baseUrl}/post-job`" class="btn btn-primary text-capitalize">{{ $t('landingpage.add_post_job') }}</a>
            </div>
          </div>
                      ...
                      <div class="d-flex align-items-center flex-sm-row flex-column gap-3 justify-content-md-end justify-content-center">
                          ...
                          <div class="flex-shrink-0">
                            <div class="search-form input-group flex-nowrap align-items-center">
                              <input type="text" class="form-control rounded-3" v-model="search" :placeholder="$t('messages.search')">
