...
<div class="mb-3 ms-2">
    <ul class="nav nav--tabs nav--tabs__style2 provider-detail-tab">
        ...
        <li class="nav-item {{request()->routeIs('handymandata.document') ? 'active' : ''}}">
            <a class="nav-link" href="{{ route('handymandata.document',$handymandata->id) }}">{{__('messages.list_form_title',['form' => __('messages.document')])}}</a>
        </li>
    </ul>
</div>
