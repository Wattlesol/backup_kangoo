    ...
    <div class="col-lg-12">
        <div class="card sanad-admin-partner-summary">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h4 class="font-weight-bold mb-1">Sanad Partner Management</h4>
                    <span class="text-muted">Partner approval, activation, workload assignment, documents, and payout visibility</span>
                </div>
                @if($auth_user->can('provider add'))
                    <a href="{{ route('provider.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> Add Partner</a>
                @endif
            </div>
            <div class="card-body">
                <div class="row">
