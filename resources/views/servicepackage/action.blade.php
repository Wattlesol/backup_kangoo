...
<a class="mr-2" href="{{ route('service-package.detail',['id' => $servicepackage->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.servicepackage') ]) }}"><i class="fas fa-link text-secondary"></i></a>
