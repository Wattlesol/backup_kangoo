    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold">{{ $pageTitle ?? trans('messages.edit_form_title',['form' => trans('messages.product')]) }}</h5>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        {{ Form::model($productdata,['method' => 'POST','route'=>['product.update', $productdata->id], 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'product'] ) }}
                        @method('PUT')
                        {{ Form::hidden('id') }}
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                {{ Form::select('track_stock', ['1' => __('messages.yes'), '0' => __('messages.no')], old('track_stock'), ['class' => 'form-control select2js']) }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                ...
                                                @if($productdata && getMediaFileExit($productdata, 'product_image'))
                                                    <label class="custom-file-label upload-label">{{ $productdata->getFirstMedia('product_image')->file_name }}</label>
                                                @else
                                        ...
                                        @if(getMediaFileExit($productdata, 'product_image'))
                                            <div class="col-md-12 mb-2">
                                                <img id="product_image_preview" src="{{ getSingleMedia($productdata,'product_image') }}" alt="product-image" class="attachment-image mt-1" style="height: 80px; width: 80px;">
                                                <a class="text-danger remove-file" href="{{ route('remove.file', ['id' => $productdata->id, 'type' => 'product_image']) }}"
