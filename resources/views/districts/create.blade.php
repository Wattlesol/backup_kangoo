...
<x-master-layout>
    <div class="container-fluid">
        ...
        <form class="mt-4" action="{{route('districts.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="form-label">{{ __('messages.region') }} <span style="color: red">*</span></label>
