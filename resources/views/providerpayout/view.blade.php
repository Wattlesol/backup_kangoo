@php
    ...
    $pageTitle = $pageTitle ?? ($isAr ? 'سجل مدفوعات الشريك' : 'Partner Payouts History');
@endphp
...
<x-master-layout>
    ...
    <div class="quick-providerpayout-page" dir="{{ $isAr ? 'rtl' : 'ltr' }}">
        ...
        <div class="quick-card mt-3">
            <div class="quick-card-header">
                <div>
                    <h3 class="quick-card-title">{{ $isAr ? 'سجل تحويلات ومدفوعات الشريك' : 'Partner Payout Transfers' }}</h3>
                    <div class="quick-card-sub">{{ $isAr ? 'تتبع التحويلات البنكية والمبالغ المصروفة وتفاصيل الحساب' : 'Track payout transactions, payment methods, bank details, and transfer amounts' }}</div>
                </div>
